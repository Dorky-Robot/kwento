defmodule KwentoWeb.UserAuthTest do
  use KwentoWeb.ConnCase, async: true

  alias Kwento.Accounts
  alias Kwento.Accounts.Scope
  alias KwentoWeb.UserAuth

  import Kwento.AccountsFixtures

  @remember_me_cookie "_kwento_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, KwentoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
